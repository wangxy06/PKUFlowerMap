...
template <> constexpr inline auto MapWidget::qt_create_metaobjectdata<qt_meta_tag_ZN9MapWidgetE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        "MapWidget",
        "flowerSelectedInQuiz",
        "",
        "flowerId"
    };

    QtMocHelpers::UintData qt_methods {
        // Signal 'flowerSelectedInQuiz'
...
void MapWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->flowerSelectedInQuiz((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (MapWidget::*)(int )>(_a, &MapWidget::flowerSelectedInQuiz, 0))
            return;
    }
}
...
// SIGNAL 0
void MapWidget::flowerSelectedInQuiz(int _t1)
{
